...
describe('callAPI', () => {
  ...
  describe('callAPI_', () => {
    ...
    it('should use the provided arguments', () => {
      ...
      // call the API
      expect(gen.next().value).toEqual(call(fetchJsonp, URL, { ...defaultCallAPIOptions, ...options }));
    ...
    it('should get a 0 status in case of an exception during the API call', () => {
      ...
      // call the API
      expect(gen.next().value).toEqual(call(fetchJsonp, URI, defaultCallAPIOptions));

      const error = new Error('fetchJsonp exception...');
